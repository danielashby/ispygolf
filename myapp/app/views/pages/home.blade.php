                ...
                <div class="col-md-8">
                    <div id="main-search" class="row">
                     ...
                     <div id="main-search" class="row" style="margin-top:22px;">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="" id="homesearch_input" autocorrect="off" name="place" placeholder="Where do you want to play?" />                
                            ...
                            <div class="col-md-3">
                                <input type="submit" class="text_white" id="homesearch_submit" value="Search"/>
                            </div>
                            </form>
